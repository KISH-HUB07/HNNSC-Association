...
import hyderabadImage from '../assets/hyderabad-landmarks.jpg';  // Import the image
...
const Hero = () => {
    ...
    // Use imported image
    const slides = [
        hyderabadImage  // Use the imported image
    ];
    ...
    return (
        <section className="hero">
            ...
            <div className="hero-content-wrapper">
                <img src={logo} alt="HNNSC Logo" className="hero-logo" />
                <h1 className="hero-title">HYDERABAD NATTUKKOTTAI NAGARATHAR</h1>
                <p className="hero-subtitle">SOCIAL AND CULTURAL ASSOCIATION</p>
                <p className="hero-blessing">|| வேல் வேல் வேற்றிவேல் || முருகா முருகா ||</p>
