    ...
    const handleMemberRegistration = async (e) => {
        ...
        try {
            ...
            await addDoc(collection(db, 'members'), {
                ...
                atHyderabad: memberAtHyderabad,
                familyMembers: familyMembers,
                createdAt: new Date().toISOString(),
                status: 'active',
            });

            alert('Registration successful! Welcome ' + memberName);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (selectedType === 'member' && userData.role !== 'member') {
                alert('Please login with member credentials!');
                await auth.signOut();
                setLoading(false);
                return;
            }
                                ...
                                {selectedType === 'member' && isNewMember && (
                                    <div>
                                        ...
                                        >
                                            ...
                                            <div className="form-group">
                                                <label htmlFor="memberPattaPer">Patta Per *</label>
                                                <input
                                                    type="text"
                                                    id="memberPattaPer"
                    ...
                    <div className="container">
                        ...
                        <div className="contact-grid">
                            ...
                            <div className="contact-card">
                                ...
                                <div className="contact-details">
                                    <p>hyderabadnagarathar@gmail.com</p>
                                </div>
                            </div>
                            <div className="contact-card">
                                <div className="contact-photo">📞</div>
